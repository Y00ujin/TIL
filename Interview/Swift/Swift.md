...
##### struct는 상속이 불가능하며 stack영역에 저장되고, 일정 크기가 넘으면 heap에 저장됩니다. 속도가 빠르며 멀티 쓰레드 환경에서 안전하고 값 타입입니다. class는 단일 상속이 가능하며, heap 영역에 저장되며 상대적으로 느립니다. 클래스는 참조타입이며, enum은 상속이 불가능합니다.
<br>
<br>
